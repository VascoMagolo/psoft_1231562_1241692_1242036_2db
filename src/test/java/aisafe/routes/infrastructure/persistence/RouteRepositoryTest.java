...
class RouteRepositoryTest {
    ...
    void findCompatibleRoutesFiltersCorrectly() {
        ...
        // Active, compatible
        springRepo.save(new RouteJpaEntity("XXX", "YYY", 45, 300.0, 100, true));
        // Active, not compatible (range)
        springRepo.save(new RouteJpaEntity("XXX", "ZZZ", 480, 7000.0, 100, true));
        // Active, not compatible (capacity)
        springRepo.save(new RouteJpaEntity("AAA", "BBB", 60, 500.0, 200, true));
        // Inactive, compatible
        springRepo.save(new RouteJpaEntity("CCC", "DDD", 35, 250.0, 50, false));
