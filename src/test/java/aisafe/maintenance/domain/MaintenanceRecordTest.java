...
class MaintenanceRecordTest {
    ...
    void ensureValidRecordIsCreated() {
        MaintenanceRecord record = new MaintenanceRecord(
                ...
                List.of(buildPart()), "Some notes", buildTemplate(), MaintenanceStatus.PLANNED, Set.of(MaintenanceComponent.ENGINE), new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000));
    ...
    void ensureBlankDescriptionThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "  ", LocalDateTime.now(), 4,
                        List.of(buildPart()), null, buildTemplate(), MaintenanceStatus.PLANNED, Set.of(MaintenanceComponent.ENGINE), new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000)));
    }
    ...
    void ensureNullPartsThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        null, null, buildTemplate(), MaintenanceStatus.PLANNED, Set.of(MaintenanceComponent.ENGINE), new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000)));
    }
    ...
    void ensureEmptyPartsThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        List.of(), null, buildTemplate(), MaintenanceStatus.PLANNED, Set.of(MaintenanceComponent.ENGINE), new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000)));
    }
    ...
    void ensureNullAircraftThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        List.of(buildPart()), null, buildTemplate(), MaintenanceStatus.PLANNED, Set.of(MaintenanceComponent.ENGINE), null, BigDecimal.valueOf(1000)));
    }
    ...
    void ensureNullTemplateThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        List.of(buildPart()), null, null, MaintenanceStatus.PLANNED, Set.of(MaintenanceComponent.ENGINE), new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000)));
    }
    ...
    void ensureNullStatusThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        List.of(buildPart()), null, buildTemplate(), null, Set.of(MaintenanceComponent.ENGINE), new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000)));
    }
    ...
    void ensureNullComponentsThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        List.of(buildPart()), null, buildTemplate(), MaintenanceStatus.PLANNED, null, new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000)));
    }
    ...
    void ensureEmptyComponentsThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        List.of(buildPart()), null, buildTemplate(), MaintenanceStatus.PLANNED, Set.of(), new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000)));
    }
    ...
    void ensureNullCostThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        List.of(buildPart()), null, buildTemplate(), MaintenanceStatus.PLANNED, Set.of(MaintenanceComponent.ENGINE), new RegistrationNumber("CS-TPA"), null));
    }
    ...
    void ensureNegativeCostThrowsException() {
        assertThrows(MaintenanceInvalidFieldException.class, () ->
                new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                        List.of(buildPart()), null, buildTemplate(), MaintenanceStatus.PLANNED, Set.of(MaintenanceComponent.ENGINE), new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(-1)));
    }
    ...
    void ensureComponentsAreImmutable() {
        ...
        MaintenanceRecord record = new MaintenanceRecord(UUID.randomUUID(), "Engine check", LocalDateTime.now(), 4,
                List.of(buildPart()), null, buildTemplate(), MaintenanceStatus.PLANNED, input, new RegistrationNumber("CS-TPA"), BigDecimal.valueOf(1000));
