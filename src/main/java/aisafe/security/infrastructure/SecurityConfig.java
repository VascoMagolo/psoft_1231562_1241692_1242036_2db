    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/aircrafts/*").hasAnyRole("BACKOFFICE_OPERATOR", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/aircrafts/*").hasAnyRole("ATCC", "BACKOFFICE_OPERATOR", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/aircraftModels/*").hasAnyRole("BACKOFFICE_OPERATOR", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/aircraftModels/*").hasAnyRole("BACKOFFICE_OPERATOR", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/aircraftModels/top-utilized").hasAnyRole("BACKOFFICE_OPERATOR", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/routes").hasAnyRole("ATCC", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/routes/*/*").hasAnyRole("ATCC", "BACKOFFICE_OPERATOR", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/routes/*/*/deactivate").hasAnyRole("ATCC", "BACKOFFICE_OPERATOR", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/routes/airport/*").hasAnyRole("ATCC", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/routes/search").hasAnyRole("ATCC", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/routes/*/*").hasAnyRole("ATCC", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/routes/*/*/history").hasAnyRole("ATCC", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/routes").hasAnyRole("ATCC", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/maintenance/records/due").hasAnyRole("MAINTENANCE_SUPERVISOR", "MAINTENANCE_TECHNICIAN", "ATCC", "ADMIN")
